...
const Projects = () => {
    return (
        <div className='lg:h-screen mt-4  relative w-full mx-auto text-center  z-10'>
            <World />
            <div className='lg:absolute top-[-10px] right-[145px] lg:top-[0px] lg:right-[410px] xl:right-[760px]'>
            ...
            <div className='w-[420px] md:w-[500px]  mx-auto flex flex-col gap-4 lg:hidden mt-10 px-6'>
                <div className='lg:ml-2 w-full bg-[#00000030]  rounded-lg shadow-sm saturate-100 backdrop-blur-md p-6'>
